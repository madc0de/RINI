...
use PDOException;
use PDOStatement;
use Rini\Core\Db\Throwable\BeginTransactionFailureException;
use Rini\Core\Db\Throwable\CommitTransactionFailureException;
use Rini\Core\Db\Throwable\EmptyValueListError;
use Rini\Core\Db\Throwable\EmptyWhereClauseError;
use Rini\Core\Db\Throwable\RollBackTransactionFailureException;
...
final class PdoDatabase implements Database {
	...
	private function __construct(PDO $pdoInstance = null, PdoDsn $pdoDsn = null, $preserveOldState = null) {
		...
		$this->attributes = [
			...
			// set the default fetch mode for this connection to use object or associative arrays
